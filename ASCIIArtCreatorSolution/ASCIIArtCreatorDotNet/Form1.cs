    ...
    public partial class Form1 : Form
    {
        ...
        private void ÓÚÍ˚Ú¸ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show($"Œ¯Ë·Í‡ {ex.Message}", "Œ¯Ë·Í‡");
                }
            }
        }
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                MessageBox.Show("œÂÓ·‡ÁÓ‚‡ÌËÂ ÌÂ Û‰‡ÎÓÒ¸");
                return;
            }
        ...
        private async void ÒÓı‡ÌËÚ¸ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ‚˚·‡Ú¸‚ÒÂToolStripMenuItem_Click(object sender, EventArgs e)
        {
